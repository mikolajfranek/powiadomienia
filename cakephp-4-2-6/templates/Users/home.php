                            ...
                            <div class="p-2 border-t border-theme-27 dark:border-dark-3">
                                 ...
                                 <?php
                                    echo $this->Html->link('<i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Wyloguj',
                                        array("controller" => "users", "action" => "logout", "e"),
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-gray-600 text-xs mt-0.5">20 July 2021</div>
                                        </div>
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-gray-600 text-xs mt-0.5">2 August 2022</div>
                                        </div>
                                        <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                                    </div>
                                </div>
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-gray-600 text-xs mt-0.5">19 January 2022</div>
                                        </div>
                                        <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                                    </div>
                                </div>
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-gray-600 text-xs mt-0.5">11 January 2021</div>
                                        </div>
                                        <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-11.jpg" title="Uploaded at 20 July 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-8.jpg" title="Uploaded at 28 August 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-15.jpg" title="Uploaded at 14 December 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-8.jpg" title="Uploaded at 2 August 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-7.jpg" title="Uploaded at 5 October 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-14.jpg" title="Uploaded at 13 November 2022">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-12.jpg" title="Uploaded at 19 January 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-9.jpg" title="Uploaded at 8 December 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-15.jpg" title="Uploaded at 22 January 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="intro-x">
                                            <td class="w-40">
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-9.jpg" title="Uploaded at 11 January 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-6.jpg" title="Uploaded at 6 December 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="/dist/images/preview-4.jpg" title="Uploaded at 9 June 2020">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="text-theme-9">+$147</div>
                                        </div>
                                    </div>
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="ml-4 mr-auto">
                                                ...
                                                <div class="text-gray-600 text-xs mt-0.5">8 January 2021</div>
                                            </div>
